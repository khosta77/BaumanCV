...
Tест №1 - Две одинаковые фотографии
  Размер фото: 1200x800
    Коэффициент: 1, время rgbToGray 12 ms, время корреляции: 3 ms
    Коэффициент: 1, время rgbToGray 11 ms, время корреляции: 3 ms
    Коэффициент: 1, время rgbToGray 11 ms, время корреляции: 3 ms
    Коэффициент: 1, время rgbToGray 11 ms, время корреляции: 3 ms
    Коэффициент: 1, время rgbToGray 11 ms, время корреляции: 3 ms
    Коэффициент: 1, время rgbToGray 11 ms, время корреляции: 3 ms
...
Tест №2 - Две разные фотографии
  Размер фото: 1200x800
    Коэффициент: 0.42244, время rgbToGray 11 ms, время корреляции: 3 ms
    Коэффициент: 0.42244, время rgbToGray 10 ms, время корреляции: 3 ms
    Коэффициент: 0.42244, время rgbToGray 10 ms, время корреляции: 3 ms
    Коэффициент: 0.42244, время rgbToGray 10 ms, время корреляции: 3 ms
    Коэффициент: 0.42244, время rgbToGray 10 ms, время корреляции: 3 ms
    Коэффициент: 0.42244, время rgbToGray 10 ms, время корреляции: 3 ms
...
Tест №3 - С разных ракурсов
  Размер фото: 960x1280
    Коэффициент: 0.665177, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.665177, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.665177, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.665177, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.665177, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.665177, время rgbToGray 10 ms, время корреляции: 4 ms
    ...
    Коэффициент: 0.665177, время rgbToGray 10 ms, время корреляции: 4 ms
  Размер фото: 960x1280
    Коэффициент: 0.77343, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.77343, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.77343, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.77343, время rgbToGray 10 ms, время корреляции: 4 ms
    Коэффициент: 0.77343, время rgbToGray 10 ms, время корреляции: 4 ms
...
Tест №4 - Размытие
  Размер фото: 960x1280
    Коэффициент: 0.795288, время rgbToGray 12 ms, время корреляции: 4 ms
    Коэффициент: 0.795288, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.795288, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.795288, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.795288, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.795288, время rgbToGray 11 ms, время корреляции: 4 ms
    ...
    Коэффициент: 0.795288, время rgbToGray 11 ms, время корреляции: 4 ms
  Размер фото: 960x1280
    Коэффициент: 0.687327, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.687327, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.687327, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.687327, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.687327, время rgbToGray 11 ms, время корреляции: 4 ms
    ...
    Коэффициент: 0.687327, время rgbToGray 11 ms, время корреляции: 4 ms
  Размер фото: 960x1280
    Коэффициент: 0.708154, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.708154, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.708154, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.708154, время rgbToGray 11 ms, время корреляции: 4 ms
    Коэффициент: 0.708154, время rgbToGray 11 ms, время корреляции: 4 ms
...
Tест №5 - Время корреляции
  Пара: 0-1
    Время корреляции(960x1280): 4 ms
    Время корреляции(960x1280): 4 ms
    Время корреляции(960x1280): 4 ms
    Время корреляции(960x1280): 4 ms
    Время корреляции(960x1280): 4 ms
...
Tест №6 - Время RGB to GRAY
  ./test_img/test_1.jpg
    Фото(1200x800) время RGBtoGRAY: 8 ms
    Фото(1200x800) время RGBtoGRAY: 6 ms
    Фото(1200x800) время RGBtoGRAY: 5 ms
    Фото(1200x800) время RGBtoGRAY: 5 ms
    Фото(1200x800) время RGBtoGRAY: 5 ms
    Фото(1200x800) время RGBtoGRAY: 5 ms
    Фото(1200x800) время RGBtoGRAY: 5 ms
  ...
  ./test_img/test_3_1_1.jpg
    Фото(960x1280) время RGBtoGRAY: 5 ms
    Фото(960x1280) время RGBtoGRAY: 4 ms
    Фото(960x1280) время RGBtoGRAY: 4 ms
    Фото(960x1280) время RGBtoGRAY: 4 ms
    Фото(960x1280) время RGBtoGRAY: 4 ms
    Фото(960x1280) время RGBtoGRAY: 4 ms
